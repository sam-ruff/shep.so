...
def measure(samples):
    ...
    try:
        ...
        mcp.batch(click(85,355), check('folder','Sent'), click(400,661),
        ...
        for cycle in range(samples):
            ...
            for case in ['cold_nested_table','warm_nested_table']:
                result = mcp.batch({'type':'measure_pixels','x':400,'y':661,
                ...
                mcp.batch(wait(200),click(400,245),check('selected','Dispatch update'),
