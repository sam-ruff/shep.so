    ...
    pub fn draw_text(
        ...
        match text {
            ...
            Text::Cached {
                ...
                // A widget's viewport is a clip, not the glyph bounds. Cached
                // dropdown labels may lie partly (or entirely) beyond it.
                // Always apply both the local viewport and the damaged layer.
                adjust_clip_mask(clip_mask, clip_bounds);
            ...
            Text::Raw {
                ...
                let clip_mask = if physical_bounds.is_within(&clip_bounds) {
                    ...
                    // The previous text item may have narrowed the shared mask.
                    adjust_clip_mask(clip_mask, clip_bounds);
                    Some(clip_mask as &_)
                };
