...
including adjacent transpositions. Numeric words match exactly. Stable title
ordering resolves ties. `matches_with` retains the pure word-scoring boundary.
...
open; the desktop algorithm choice does not establish client parity.
