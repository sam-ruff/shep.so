...
`flutter/rust/src/folders.rs` owns schema 23's requests and catalogue metadata.
...
Folder rename/move/delete, complete mobile folder trees and large-catalogue
performance are separate work. The existing generic sync permit order is
