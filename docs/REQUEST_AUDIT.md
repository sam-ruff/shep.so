...
| R38 | Render HTML like supplied examples, including the later raw-XHTML tags; preserve layout/images and selectable text | Implemented and verified: MIME/XHTML selection, worker-rendered static HTML, native text copy, plain mode, quotes, inline/remote images and wide-table scrolling; publication evidence follows in COMPLETION |
