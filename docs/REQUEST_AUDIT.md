...
| R102 | The taskbar badge shows a higher number than the current unread email count; it must equal the unread count at that moment (14 September 2026) | Open in TODO; lane started 14 September |
