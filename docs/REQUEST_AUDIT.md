...
| R103 | Use the safe and correct search query rather than unsafe FTS5 FFI, and raise the benchmark budget to match it (15 September 2026) | `e585cdb` reverted; search budgets set to 100 ms (one or two terms) and 150 ms (four terms) with page and body budgets unchanged; runner confirmation pending |
