...
| R69 | HTML layout moves during rendering, visual artifacts and slow readiness; investigate more pre-caching/rendering | Partially delivered in cd8f732: actual viewport loading, stale-frame isolation, worker font reuse and bounded adjacent-frame preparation have Rust/native evidence; remaining controls/compact layout and final readiness work are tracked in TODO; timing deferred |
