...
| R15 | Remove useless local-device/privacy slogans, keeping useful explanations | Navigation copy cleaned; final copy review remains open. Preferences scale-control clipping has a renderer fix and saved native pixel regression; see completion log |
