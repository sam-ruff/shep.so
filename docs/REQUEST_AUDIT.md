...
| R69 | HTML layout moves during rendering, visual artifacts and slow readiness; investigate more pre-caching/rendering | Partially delivered in cd8f732: actual viewport loading, stale-frame isolation, worker font reuse and bounded adjacent-frame preparation. The follow-up stabilizes image/pan control placement, compact attachment space and resized Find results with Rust/native evidence; remaining late-image scroll anchoring and readiness review stay in TODO; timing deferred |
