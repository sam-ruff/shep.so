...
`MoveConnections` seam, saves the listing and fails before submission when the
listing fails. Dragging onto the unified Archive/Trash/Spam rows now accepts an
