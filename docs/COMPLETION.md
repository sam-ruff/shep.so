...
clears it and adds a controller/native assertion. All 35 final native profile scenarios pass in 171.199 seconds, including
the corrected stale-card assertion; root reviewed the final Keep and Remove
WebPs in `be426d49a6b1` and `52457d6367e4`. Normal hooks and main integration
remain pending. Final native SHA-256:
