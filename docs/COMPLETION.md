...
| Reader, sender actions, attachments, image policy, quote display | Native reader/full-window reader, copy dialog, wrapping received attachments, image exceptions, collapsed/expanded/latest quote preferences | Separate-message conversation grouping and server Sent handling |
