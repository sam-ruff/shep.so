...
const SETTINGS: &[Setting] = &[
    ...
    Setting {
        ...
        keywords: "backup all include multiple retry progress drive s3 sftp ssh host fingerprint username ftp ftps tls bucket endpoint region access key destination folder rolling copies retention schedule passphrase password encryption",
    },
    Setting {
