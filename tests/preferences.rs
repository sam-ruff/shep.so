...
async fn preferences_revision_survives_reopen_and_failed_validation_is_atomic() {
    ...
    assert_eq!(workspace.preferences.mail_check_seconds, 20);
...
fn older_settings_gain_frequent_mail_checks_and_new_values_round_trip() {
    ...
    assert_eq!(preferences.mail_check_seconds, 5);
    preferences.mail_check_seconds = 15;
    ...
    assert_eq!(reloaded.mail_check_seconds, 15);
